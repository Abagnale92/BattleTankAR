...
public class FuocoTouch : Photon.MonoBehaviour {
    ...
    private void genera() {
        ...
        shellInstance2 = (GameObject)PhotonNetwork.Instantiate("Shell", cloneShell.transform.position, cloneShell.transform.rotation,0); //instanzia in rete 
